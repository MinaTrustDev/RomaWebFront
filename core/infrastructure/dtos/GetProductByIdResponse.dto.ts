import { ProductVariationsResponseDTO } from "./ProductVariationsResponse.dto";

export type GetProductByIdResponseDTO = Root2;
...
interface Root2 {
  ...
  branch_ids: number[];
  variations: ProductVariationsResponseDTO[];
}
